...
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Mise à la consommation directe (IM4 - TTC)', 1) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Mise à la consommation sous exonération (IM4 - EXO)', 2) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Transit National / International (IM8 - DDI / TRIE)', 3) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Admission Temporaire (IM5 - AT)', 4) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Enlèvement provisoire', 5) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Entrepôt de Douane (IM7 - ED)', 6) ON CONFLICT (category, label) DO NOTHING;
INSERT INTO reference_items (category, label, "sortOrder") VALUES ('regime', 'Exportation / Réexportation (EX)', 7) ON CONFLICT (category, label) DO NOTHING;
